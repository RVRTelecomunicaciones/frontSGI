...
@Component({
  selector: 'modal-form-tipo-cotizacion',
  styles: [
    `
      .invalid-touched {
        color: #ff4d4f;
  ...
  templateUrl: './tipo-cotizacion-add.component.html',
})
export class ModalFormTipoCotizacionComponent implements OnInit {
  @Input() public position!: TipoCotizacionModel;
  ...
  onUpdate({}: { value: TipoCotizacionModel; valid: boolean }) {
