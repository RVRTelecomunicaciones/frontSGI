...
@Component({
  selector: 'app-clasificacion-involucrado-add',
  styles: [
    `
      .invalid-touched {
        color: #ff4d4f;
  ...
  templateUrl: './clasificacion-involucrado-add.component.html',
})
export class ModalFormClasificacionInvolucradoComponent implements OnInit {
  @Input() public position!: ClasificacionInvolucradoModel;
  ...
  onUpdate({}: { value: ClasificacionInvolucradoModel; valid: boolean }) {
