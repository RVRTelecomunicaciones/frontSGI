...
@Component({
  ...
  templateUrl: './desglose-add.component.html',
})
export class ModalFormDesgloseComponent implements OnInit {
  @Input() public position!: DesgloseModel;
  ...
  onUpdate({}: { value: DesgloseModel; valid: boolean }) {
