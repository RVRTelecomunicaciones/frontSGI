...
@Component({
  ...
  templateUrl: './requisito-add.component.html',
})
export class ModalFormRequisitoComponent implements OnInit {
  @Input() public position!: RequisitoModel;
  ...
  onUpdate({}: { value: RequisitoModel; valid: boolean }) {
